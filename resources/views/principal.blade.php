                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="nav-link" href="{{url('pago',Crypt::encrypt($bill->id))}}"><i class="fa fa-fw fa-credit-card"></i> Registrar Pago</a>
                                                        </td>
                                                            <td><span class="badge-dot badge-danger mr-1"></span>Sin Pagar</td>                 
                                                        @endif
                                                        @if($bill->estado == "Procesando")
                                                        <td>
                                                            <a class="nav-link" href="{{url('pagou',Crypt::encrypt($bill->id))}}"><i class="fa fa-fw fa-edit"></i>{{ $bill->transferencia }}</a>
                                                        </td>
