                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 style="text-align: center;" class="pageheader-title">Eliminar Factura</h2>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
                        ...
                        <div class="card-header card-header-primary text-center">
                          <div class="social-line">
                             ...
                             <div class="form-group{{ $errors->has('mes') ? ' has-error' : '' }}">
                                <label class="col-md-12 control-label" style="text-align: center;">Mes de la Factura</label>
                            ...
                            <div class="form-group{{ $errors->has('año') ? ' has-error' : '' }}">
                                <label class="col-md-12 control-label" style="text-align: center;">Año de la Factura</label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
