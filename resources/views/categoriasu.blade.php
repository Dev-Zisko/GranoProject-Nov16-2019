                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 style="text-align: center;" class="pageheader-title">Editar Categoría</h2>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
                          ...
                          <div class="social-line">
                            <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
                                <div class="input-group mb-3">
                                    ...
                                    <input id="nombre" name="nombre" type="text" class="form-control"  value="{{ $category->nombre }}" required>
