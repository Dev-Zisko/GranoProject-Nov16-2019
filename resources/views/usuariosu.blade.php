                          ...
                          <div class="social-line">
                            ...
                            <div class="form-group{{ $errors->has('cedula') ? ' has-error' : '' }}">
                                <div class="input-group mb-3">
                                    ...
                                    <input id="cedula" name="cedula" type="number" class="form-control" placeholder="Cédula..." value="{{ $user->cedula }}" min="0" required>
                            ...
                            <div class="form-group{{ $errors->has('piso') ? ' has-error' : '' }}">
                                <div class="input-group mb-3">
                                    ...
                                    <input id="piso" name="piso" type="number" class="form-control" placeholder="Piso..." value="{{ $user->piso }}" min="0" required>
                                    @if ($errors->has('piso'))
                                        <span class="help-block">
