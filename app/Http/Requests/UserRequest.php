...
class UserRequest extends FormRequest
{
    ...
    public function rules()
    {
      return [
          ...
          'piso' => 'required|string|max:255|regex:/^[0-9]+$/',
          'apartamento' => 'required|string|max:255|regex:/^[0-9]+$/',
    ...
    public function messages()
    {
        return [
          ...
          'piso.regex' => 'Solo se aceptan numeros.',
          'apartamento.regex' => 'Solo se aceptan numeros.',
        ];
    }
}
